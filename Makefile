...
CFLAGS=-std=c11 -O0 -pipe -Wno-implicit-function-declaration -Wall -Wextra -Wno-unused-function -Wno-implicit-fallthrough -ftrapv -fstack-protector-all -fstack-protector-strong #-pedantic
